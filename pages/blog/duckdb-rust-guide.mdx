...
description: "Use DuckDB from Rust with the duckdb crate: connections, prepared statements, the Appender for fast inserts, Arrow record batches, Parquet and S3 access, and threading patterns."
